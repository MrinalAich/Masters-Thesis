...
class Orchestrator(app_manager.RyuApp):
    ...
    def _slaInputThread(self):
        ...
        # qqq
        slaObject  = struct_SLA(self.m_SLAsCount, ['Firewall'], [10], 10, 100, ['00:00:00:00:00:11', '00:00:00:00:00:32'], [1,3])
        slaObject  = struct_SLA(self.m_SLAsCount, ['Firewall'], [10], 10, 100, ['00:00:00:00:00:11', '00:00:00:00:00:31'], [1,3])
        slaObject  = struct_SLA(self.m_SLAsCount, ['Firewall', 'Firewall'], [10, 10], 10, 100, ['00:00:00:00:00:11', '00:00:00:00:00:31'], [1,3])

        slaObject  = struct_SLA(self.m_SLAsCount, ['Firewall', 'Firewall'], [10, 10], 10, 100, ['00:00:00:00:00:11', '00:00:00:00:00:41'], [1,4])
        slaObject  = struct_SLA(self.m_SLAsCount, ['Firewall'], [10], 10, 100, ['00:00:00:00:00:11', '00:00:00:00:00:42'], [1,4])
    ...
    def placementOfSLA(self, sla):
        ...
        if False and gNodeBottleneckHackCount == True:
            ...
            bottleneckedDpid = 2
            LOG_DEBUG("Tweaked Bottleneck detected at Hypervisor(%s)." % bottleneckedDpid)
    ...
    def removeOldSLAFlowRules(self, sla, src_mac, dst_mac, path, oldVNFsNetworkDpid, oldVNFsNetworkMac):
        ...
        while True:
            ...
            if processed_vnf_cnt == len(oldVNFsNetworkDpid):
                break
    ...
    def migrateVNF_RestOp(self, savedContext, new_dpid):
        ...
        LOG_DEBUG("Successful Migration in SLA (%s) of Old VNF(%s) from Hypervisor(%s) as New VNF(%s) at Hypervisor(%s)" % 
    ...
    def migrateVNF_VNFStartOp(self, dpid, new_dpid, vnfId):
        ...
        ## Step 2 : Start VNF at the Nbr Hypervisor with same configuration
